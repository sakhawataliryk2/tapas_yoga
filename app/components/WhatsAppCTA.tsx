...
export default function WhatsAppCTA() {
  return (
    <section id="whatsapp" style={{ backgroundColor: "#F8F4EE" }} className="py-16 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-14">
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between gap-10">
          ...
          <div className="max-w-xl">
            ...
            >
              Questions Before<br />
              <em style={{ fontStyle: "italic", color: "#A8784A" }}>Booking?</em>
            </h2>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1.0625rem", color: "#7A6E64", lineHeight: 1.75 }}>
              Have questions about the training, rooms, or certification?
              Message us directly on WhatsApp for fast personal support.
            </p>
          </div>
          ...
          <div className="flex-shrink-0 pb-1">
            <a
              ...
              className="flex items-center gap-4 px-10 py-5 transition-colors"
